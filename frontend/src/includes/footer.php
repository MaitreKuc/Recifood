<footer class="mt-auto border-t border-slate-200 bg-white py-6 text-slate-500 text-xs">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div class="flex items-center space-x-6 text-slate-400">
            ...
            <span><i class="fa-brands fa-python mr-1"></i> Python FastAPI</span>
            <span><i class="fa-brands fa-php mr-1"></i> PHP 8.2</span>
            <span><i class="fa-brands fa-docker mr-1"></i> Docker</span>
        </div>
    </div>
</footer>
</body>
